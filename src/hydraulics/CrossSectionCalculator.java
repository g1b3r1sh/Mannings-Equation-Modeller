...
public class CrossSectionCalculator<M extends Number, N extends Number>
{
	...
	public CrossSectionCalculator(DiscreteData<M, N> data, Number waterLevel)
	{
		if (waterLevel == null)
		{
	...
	public double crossSectionArea()
	{
		...
		this.data.iterateSegments( (left, right) -> area.value += CrossSectionCalculator.this.calcArea(left, right) );
		return area.value;
	}
